...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
    ...
    @Override
    public List<SysMenuVO> tree(SysMenuVO query) {
        LambdaQueryWrapper<SysMenu> wrapper = new LambdaQueryWrapper<SysMenu>()
                .like(query != null && StringUtils.hasText(query.getMenuName()), SysMenu::getMenuName, query.getMenuName())
                .eq(query != null && query.getMenuType() != null, SysMenu::getMenuType, query.getMenuType())
                .eq(query != null && query.getStatus() != null, SysMenu::getStatus, query.getStatus())
